...
```gradle
dependencies {
    implementation 'com.github.apiverve:countrylanguages-api:1.1.14'
}
```
...
```java
import com.apiverve.countrylanguages.CountryLanguagesAPIClient;
import com.apiverve.countrylanguages.APIResponse;
import com.apiverve.countrylanguages.APIException;

// Initialize the client
CountryLanguagesAPIClient client = new CountryLanguagesAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("name", "ZW");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/countrylanguages](https://docs.apiverve.com/ref/countrylanguages)
...
- **Documentation:** [https://docs.apiverve.com/ref/countrylanguages](https://docs.apiverve.com/ref/countrylanguages)
- **Issues:** [GitHub Issues](https://github.com/apiverve/countrylanguages-api/issues)
