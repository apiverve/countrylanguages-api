...
namespace APIVerve.API.CountryLanguages
{
    ...
    /// <summary>
    /// Client for the CountryLanguages API
    /// </summary>
    public class CountryLanguagesAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/countrylanguages";
        ...
        public CountryLanguagesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CountryLanguagesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CountryLanguagesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CountryLanguagesQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CountryLanguagesQueryOptions options)
        {
        ...
        public ResponseObj Execute(CountryLanguagesQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CountryLanguagesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CountryLanguagesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CountryLanguagesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CountryLanguagesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CountryLanguagesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CountryLanguagesQueryOptions options)
        {
