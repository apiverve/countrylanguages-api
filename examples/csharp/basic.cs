/*
 * Country Languages API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Country Languages API.
 * API Documentation: https://docs.apiverve.com/ref/countrylanguages
 */
...
{
    class CountryLanguagesExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/countrylanguages";

        /// <summary>
        /// Make a GET request to the Country Languages API
        /// </summary>
        static async Task<JsonDocument> CallCountryLanguagesAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;name&quot;] &#x3D; &quot;ZW&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Country Languages API...\n");

            var result = await CallCountryLanguagesAPI();
