...
namespace APIVerve\Countrylanguages;
...
/**
 * Client for the Country Languages API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/countrylanguages?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/countrylanguages';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CountrylanguagesClient] {$message}\n";
        }
    }
}
