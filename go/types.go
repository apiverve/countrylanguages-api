...
// Request contains the parameters for the Country Languages API.
//
// Parameters:
...
// ResponseData contains the data returned by the Country Languages API.
type ResponseData struct {
	Country string `json:"country"`
	Name string `json:"name"`
	OfficialName string `json:"officialName"`
	OfficialLanguages []string `json:"officialLanguages"`
	OfficialLanguageCount int `json:"officialLanguageCount"`
}
